...
export function SubmitButton({ handleSubmit }) {
    return (
        <button
            type={handleSubmit ? "button" : "submit"} // Fallback to native submit if no handler passed
            onClick={handleSubmit || undefined} // Only add onClick if needed
